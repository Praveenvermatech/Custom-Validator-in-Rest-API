...
public class UserController {
  ...
  public ResponseEntity<UserDetailModel> createUser(
      @Valid @RequestBody UserDetailModel requestUserDetails) {
  ...
  @GetMapping("{id}")
  public ResponseEntity<UserDetailModel> getUSer(@PathVariable @Positive Long id) {
    UserDetailModel model = service.getUser(id);
    return ResponseEntity.ok(model);
  }
